...
log.warn("/usr/bin/python /jira_home/scripts/automation/confluence_picker/generate_confluence_space_list.py".execute().text)

def parsedFile = new File(jiraHome.localHomePath + "/scripts/automation/confluence_picker/confluence_space_list").getText("UTF-8")
...
def customField = customFieldManager.getCustomFieldObjectByName("Confluence Space Picker")
